  ...
  return (
    <>
      ...
      <header className="relative hidden shrink-0 lg:grid lg:grid-cols-[1.15fr_0.85fr]">
        <div className="relative px-6 pt-8 3xl:px-14 3xl:pt-14 4xl:px-14 4xl:pt-16">
          ...
          <div className="fixed left-1/2 top-8 z-30 hidden -translate-x-1/2 lg:block 3xl:top-14 4xl:top-16">
            <Link href="/" className="hover:opacity-80">
              <BiuLogo className="text-about-accent 3xl:text-5xl 4xl:text-5xl" />
            </Link>
          </div>
        </div>
        <div className="relative">
          <div className="absolute right-6 top-6 z-20 flex items-center gap-6 text-sm text-about-accent 2xl:text-sm 3xl:right-14 3xl:top-12 3xl:gap-10 3xl:text-xl 4xl:right-14 4xl:top-14 4xl:gap-10 4xl:text-3xl">
            <span>{t('about')}</span>
            <LanguageToggle theme="about" />
          </div>
        </div>
