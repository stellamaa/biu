            ...
            <div className="grid min-h-0 flex-1 grid-cols-[1.15fr_0.85fr] gap-x-12 overflow-hidden 3xl:grid-cols-[1.22fr_0.78fr] 3xl:gap-x-16 4xl:gap-x-20">
              <div className="flex min-h-0 flex-col pr-20 3xl:pr-28 4xl:pr-36">
                ...
                <AboutContact
                  ...
                  telephone1={about.telephone1}
                  telephone2={about.telephone2}
                  className="mb-6 shrink-0 pt-6 3xl:pt-10 4xl:pt-10"
                />
              </div>
              <div className="flex min-h-0 justify-end pl-4 lg:pr-12 3xl:h-full 3xl:items-stretch 3xl:pl-6 3xl:pr-16 4xl:pl-8 4xl:pr-24">
                <AboutImage
                  image={about.aboutImage}
                  fitHeight
                  className="ml-auto max-w-[min(100%,580px)] 2xl:max-h-75%] 2xl:max-w-[min(100%,640px)] 2xl:self-start 3xl:h-full 3xl:max-h-full 3xl:max-w-[min(100%,920px)] 3xl:self-auto 4xl:max-w-[min(100%,1320px)]"
                />
              </div>
            </div>
          </div>
