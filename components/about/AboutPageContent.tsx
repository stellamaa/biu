    ...
    >
      ...
      {about ? (
        <>
          ...
          <div className="hidden min-h-0 flex-1 overflow-hidden lg:flex lg:flex-col lg:px-6 lg:pb-8 lg:pt-18 3xl:px-14 3xl:pb-12 3xl:pt-15 4xl:px-14 4xl:pb-12 4xl:pt-28">
            <div className="grid min-h-0 flex-1 grid-cols-[1.15fr_0.85fr] gap-x-12 overflow-hidden 3xl:grid-cols-[1.5fr_0.70fr] 3xl:gap-x-0 4xl:gap-x-20">
              <div className="flex h-full min-h-0 flex-col pr-20 3xl:pr-28 4xl:pr-36">
                <div className="flex min-h-0 flex-1 flex-col space-y-5 overflow-hidden 3xl:space-y-7 3xl:pt-45 4xl:space-y-9 4xl:pt-0">
                  <AboutSectionHeading foundedYear={about.biuFoundedYear} />
                  <AboutDescription
                    sourceText={about.biuDescription}
                    initialDisplay={about.biuDescriptionDisplay}
                ...
                <AboutContact
                  ...
                  telephone1={about.telephone1}
                  telephone2={about.telephone2}
                  className="shrink-0 pt-6 3xl:pb-45 4xl:pt-10"
                />
              </div>
              <div className="flex h-full min-h-0 items-end justify-end pl-4 lg:pr-12 3xl:pl-6 3xl:pr-16 4xl:pl-8 4xl:pr-24">
                <AboutImage
                  ...
                  fitHeight
                  className="ml-auto max-h-full max-w-[min(100%,580px)] 2xl:max-w-[min(100%,640px)] 3xl:max-h-[90dvh] 3xl:max-w-[min(100%,1140px)] 4xl:max-h-full 4xl:max-w-[min(100%,1320px)]"
                />
              </div>
            </div>
          </div>
